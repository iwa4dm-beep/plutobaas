...
const groups: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/dashboard/ops/executions", label: "Ops executions", icon: ScrollText },
      { to: "/dashboard/ops/audit", label: "Ops audit log", icon: ScrollText },
      { to: "/dashboard/ops/settings", label: "Ops settings", icon: ScrollText },
      { to: "/dashboard/ops/migrations", label: "Migrations dry-run/rollback", icon: ScrollText },
      { to: "/dashboard/ops/docker-check", label: "Docker connectivity", icon: Server },
      { to: "/dashboard/ops/explain", label: "EXPLAIN analyzer", icon: Activity },
      { to: "/dashboard/ops/rls-debug", label: "RLS debugger", icon: Activity },
      { to: "/dashboard/ops/jwt-inspect", label: "JWT inspector", icon: Terminal },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/dashboard/key-rotation", label: "Key rotation", icon: KeyRound },
      { to: "/dashboard/local-stack", label: "Local Docker stack", icon: Package },
      { to: "/dashboard/webhook-tester", label: "Webhook tester", icon: Waves },
      { to: "/dashboard/rbac-templates", label: "RBAC & RLS templates", icon: Shield },
  ...
  },
  {
    label: "Help",
    items: [
      { to: "/dashboard/help/connect-roadmap", label: "Connect & Go-Live Roadmap", icon: ScrollText },
